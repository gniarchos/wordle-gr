...
export default function Navbar() {
  ...
  return (
    <div className="navbar">
      ...
      {openStatistics && (
        <div style={pushFilterStyle} className="popup-bg">
          <div className="popup-div">
                ...
                <div className="data-div">
                  <p className="number-data">
                    {localStorage.getItem("winPercent")
                      ? parseFloat(localStorage.getItem("winPercent")).toFixed(
                          1
                        )
                      : "0"}{" "}
                    %
            ...
            <div className="attempts-wrapper">
              ...
              <div className="meter">
                <p className="bar" style={bar_progress_1}>
            ...
            <div className="attempts-wrapper">
              ...
              <div className="meter">
                <p className="bar" style={bar_progress_2}>
                  <span className="bar-number">
            ...
            <div className="attempts-wrapper">
              ...
              <div className="meter">
                <p className="bar" style={bar_progress_3}>
                  <span className="bar-number">
            ...
            <div className="attempts-wrapper">
              ...
              <div className="meter">
                <p className="bar" style={bar_progress_4}>
                  <span className="bar-number">
            ...
            <div className="attempts-wrapper">
              ...
              <div className="meter">
                <p className="bar" style={bar_progress_5}>
                  <span className="bar-number">
            ...
            <div className="attempts-wrapper">
              ...
              <div className="meter">
                <p className="bar" style={bar_progress_6}>
                  <span className="bar-number">
          ...
          <div className="popup-div info">
            ...
            <div className="popup-content">
              ...
              <p className="game-info">
                ...
                button to submit your guess. After each guess the color of the
                tiles will change to indicate how close your guess was to the
                answer.
              </p>
            </div>
